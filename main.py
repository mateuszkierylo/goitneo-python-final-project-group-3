...
class Record:
    ...
    def __str__(self):
        ...
        email_str = ", emial:" + ", ".join (str(email.value) for email in self.email) if self.email else ""
        return f"Contact name: {self.name.value}, phones: {phone_str}{birthday_str}{address_str}{email_str}"
